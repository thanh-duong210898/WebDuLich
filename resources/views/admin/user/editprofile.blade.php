    ...
    <div class="container-fluid">
        <div class="row m-y-2">
            ...
            <div class="col-lg-8 push-lg-4 personal-info">
                <form role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input required="" class="form-control @error('state_address') is-invalid @enderror" type="text" value="{{$user->state_address}}" name="state_address" placeholder="Address" />
                        </div>
                    </div>
                    <div class="form-group row">
            ...
            <div class="col-lg-4 pull-lg-8 text-xs-center">
                <img style="width: 150px;height: 150px;" src="{{ asset('admin/upload/user_profile'.'/'.$user->image) }}" class="m-x-auto img-fluid img-circle" alt="avatar" />
