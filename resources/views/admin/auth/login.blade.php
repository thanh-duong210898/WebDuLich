                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{ route('postLogin') }}" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user @error('email') is-invalid @enderror" value="{{ old('email') }}" required autocomplete="email" autofocus name="email" placeholder="Nhập Email...">
                                            @error('email')
