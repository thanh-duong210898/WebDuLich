...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin/css/customCSS.css') }}">
    <link rel="stylesheet" href="{{ asset('admin/vendor/loadingModal/jquery.loadingModal.css') }}">
    <!-- datatable css -->
    @yield('style')
</head>
...
<body id="page-top">
    ...
    <script src="{{ asset('admin/js/jquery-3.1.1.slim.min.js') }}"></script>
