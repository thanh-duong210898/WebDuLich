      ...
      <div class="card-body">
         <form role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="form-group row">
                     ...
                     <div class="col-lg-4">                     
                        <input required="" class="form-control @error('inventory') is-invalid @enderror" type="number" name="amount" value="{{isset($product->inventory) ? $product->inventory : old('name')}}" placeholder="0" />
                     </div>
            ...
            <div class="col-lg-4 pull-lg-8 text-xs-center">
               <img style="" src="{{(!isset($product->image)) ? '' : asset("upload/images").'/'.$product->image}}" class="m-x-auto img-fluid " alt="avatar" />
