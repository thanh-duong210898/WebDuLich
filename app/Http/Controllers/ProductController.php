...
class ProductController extends Controller
{
    ...
    public function datatables(){
        ...
        ->addColumn('action',function($product){
            ...
            <i class="fas fa-edit"></i></a> 
                <a href="#" data-id='.$product->id.' class="btn btn-danger btn-sm delete"><i class="fas fa-truck"></i></a>';
        })
        ...
        ->addColumn('checkBestSeller',function($product){
            ...
            return '<input '.$checked. ' data-name='.$product->name.' data-id='.$product->id.' class="check_best_seller checkbox_type" type="checkbox" data-toggle="toggle" data-size="sm">';           
        })
    ...
    public function post_add(Request $request){
        ...
        $product->inventory = $request->amount ?? 0;
        ...
        return redirect()->route('product')->with('success','Add Success');
    }
