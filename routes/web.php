...
Route::group(['prefix' => 'admin','middleware' => ['auth']], function() {
    ...
    Route::group(['prefix' => 'inventory'], function() {
        ...
        Route::get('/edit','InventoryController@get_edit')->name('edit-inventory');
        Route::post('/edit','InventoryController@post_edit')->name('postEditInventory');
        Route::post('/','InventoryController@create')->name('addInventory');
        Route::get('/add','InventoryController@get_add')->name('get_add_inventory');
        Route::post('/add','InventoryController@post_add');
        Route::post('/delete','InventoryController@delete')->name('inventory_delete');
        Route::get('/datatables','InventoryController@datatables')->name('datatables_inventory');
    });
